...
- **[param8-remote-script](https://github.com/KBLiveSolutions/param8-remote-script)** - Ableton Live Control Surface script for native integration with Live's device/mixer parameters
...
6. Ableton Live users can install [param8-remote-script](https://github.com/KBLiveSolutions/param8-remote-script) for native Control Surface integration (device/mixer parameter mapping without manual MIDI learn)
